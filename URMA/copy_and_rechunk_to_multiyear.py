...
from process_and_write_to_zarr import ensure_initialized, project_dir


BASE_SRC = "/network/rit/lab/basulab/Projects/DFS/DATA/URMA_NYS"
...
def copy_year(
    ...
    # Drop coords without a time dimension; region writes require overlap with the region dims
