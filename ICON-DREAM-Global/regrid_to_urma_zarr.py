# %%
"""Regrid ICON-DREAM-Global Zarr to URMA HR/LR Zarr stores.
...
SOURCE_NAME = "ICON_DREAM_Global_NYS"
...
def init_zarr_store(
    ...
    global_title: str = "ICON-DREAM-Global regridded to URMA grid",
...
def regrid_and_write_month(
    ...
    if to_hr:
        out = regridders.icon_global_to_urma_hr(data)
    else:
        out = regridders.icon_global_to_urma_lr_intended(data)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Regrid ICON-DREAM-Global Zarr to URMA HR/LR grids."
    )
    parser.add_argument(
        "--var_name",
        type=str,
